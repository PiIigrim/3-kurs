...
df = pd.read_csv('C:\\work\\2 semestr\\МРЗИС\\лаба3\\function_values.csv', delimiter=',', nrows = 1000)
...
X_test, y_test = get_test_data(sin_wave[:len(sin_wave)], seq_len, 70)
...
for epoch in range(epochs):
    ...
    for i in range(len_data):
        ...
        print("data left: {}".format(len_data - (i + 1)))
